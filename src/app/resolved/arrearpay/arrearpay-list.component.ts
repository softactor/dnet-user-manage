...
export class ArrearpayListComponent implements OnInit {
  ...
  constructor(
    ...
    this._service.getListData(this.authorizationKey, 'resolved/arrearpay/list/').subscribe( response => {
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'resolved/arrearpay/delete/').subscribe( response => {
      ...
      this._service.getListData(this.authorizationKey, 'resolved/arrearpay/list/').subscribe( listResponse => {
