...
@Component({
  selector: 'app-deadbody-repatriation-list',
  templateUrl: './deadbody-repatriation-list.component.html'
})
export class DeadbodyRepatriationListComponent implements OnInit {
  editId;
  authorizationKey;
  tableListData;
  tableDeleteData;
  ...
  constructor(
    ...
    this._activateRoute.paramMap
      .subscribe( params => {
        ...
        this.listApi  = 'resolved/deadbodyrepatriation/list?type=' + this.list_param;
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'resolved/deadbodyrepatriation/delete/').subscribe( response => {
      this.tableDeleteData = response;
      this._toasterService.success('Data have been successfully deleted.');
      this._service.getListData(this.authorizationKey, 'resolved/deadbodyrepatriation/list/').subscribe( listResponse => {
