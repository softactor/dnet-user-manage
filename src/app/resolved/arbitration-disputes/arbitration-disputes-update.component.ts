...
@Component({
  ...
  templateUrl : 'arbitration-disputes-update.component.html'
})
export class ArbitrationDisputesUpdateComponent implements OnInit {
  editId;
  editData;
  inputFields;
  formData;
  ...
  ngOnInit() {
    ...
    this.formData = this.fb.group({
      ...
      resolved_case             : ['', Validators.required],
      type                      : ['', Validators.required]
    });
    this._activateRoute.paramMap
      .subscribe( params => {
        this.editId = params.get('arbitration_disputes_id')
