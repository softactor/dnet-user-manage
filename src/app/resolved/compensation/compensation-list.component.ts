...
export class CompensationListComponent implements OnInit {
  ...
  constructor(
    ...
    this._service.getListData(this.authorizationKey, 'resolved/compensation/list/').subscribe( response => {
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'resolved/compensation/delete/').subscribe( response => {
      ...
      this._service.getListData(this.authorizationKey, 'resolved/compensation/list/').subscribe( listResponse => {
