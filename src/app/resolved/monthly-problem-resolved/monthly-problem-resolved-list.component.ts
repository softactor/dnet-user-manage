...
@Component({
  ...
  templateUrl: './monthly-problem-resolved-list.component.html'
})
export class MonthlyProblemResolvedListComponent implements OnInit {
  editId;
  authorizationKey;
  tableListData;
  tableDeleteData;
  ...
  constructor(
    ...
    this._service.getListData(this.authorizationKey, 'resolved/monthlyproblemresolved/list/').subscribe( response => {
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'resolved/monthlyproblemresolved/delete/').subscribe( response => {
      ...
      this._service.getListData(this.authorizationKey, 'resolved/monthlyproblemresolved/list/').subscribe( listResponse => {
