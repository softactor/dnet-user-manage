...
export class GeneralAssistanceListComponent implements OnInit {
  ...
  constructor(
    ...
    this._service.getListData(this.authorizationKey, 'assistanceprovidation/generalassistance/list/').subscribe( response => {
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'assistanceprovidation/generalassistance/delete/').subscribe( response => {
      ...
      this._service.getListData(this.authorizationKey, 'assistanceprovidation/generalassistance/list/').subscribe( listResponse => {
