...
@Component({
  ...
  templateUrl: './guest-entertainment-list.component.html'
})
export class GuestEntertainmentListComponent implements OnInit {
  editId;
  authorizationKey;
  tableListData;
  tableDeleteData;
  ...
  constructor(
    ...
    this._activateRoute.paramMap
      .subscribe( params => {
        ...
        this.listApi  = 'activity/gestentertainment/list?type=' + this.list_param;
