...
export class TradeQueryListComponent implements OnInit {
  editId;
  authorizationKey;
  tableListData;
  tableDeleteData;
  ...
  delete(deleteId) {
    ...
    this._service.delete(deleteParam, 'querycomplain/tradequery/delete/').subscribe( response => {
      ...
      this._service.getListData(this.authorizationKey, 'querycomplain/tradequery/list/').subscribe( listResponse => {
