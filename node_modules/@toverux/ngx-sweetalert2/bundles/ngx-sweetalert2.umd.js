(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', 'sweetalert2', '@angular/core', '@angular/common'], factory) :
	(factory((global['ngx-sweetalert2'] = {}),global.swal,global.ng.core,global.ng.common));
...
var SwalComponent = (function () {
    ...
    SwalComponent.prototype.show = function () {
        ...
        var /** @type {?} */ options = Object.assign({}, this.defaultSwalOptions, this.options, {
            ...
            onBeforeOpen: function (modalElement) { return _this.beforeOpen.emit({ modalElement: modalElement }); }, onOpen: function (modalElement) { return _this.open.emit({ modalElement: modalElement }); }, onClose: function (modalElement) { return _this.close.emit({ modalElement: modalElement }); }
        });
        //=> Show the Swal!
...
var SwalDirective = (function () {
    ...
    SwalDirective.prototype.ngOnInit = function () {
        ...
        this.confirmSubscription = this.swalInstance.confirm.asObservable().subscribe(function (v) { return _this.confirm.emit(v); });
        this.cancelSubscription = this.swalInstance.cancel.asObservable().subscribe(function (v) { return _this.cancel.emit(v); });
    };
    /**
...
var SweetAlert2Module = (function () {
...
//# sourceMappingURL=ngx-sweetalert2.umd.js.map
