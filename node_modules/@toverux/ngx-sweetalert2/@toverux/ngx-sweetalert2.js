...
class SwalComponent {
    ...
    show() {
        ...
        const /** @type {?} */ options = Object.assign({}, this.defaultSwalOptions, this.options, { 
            ...
            onBeforeOpen: (modalElement) => this.beforeOpen.emit({ modalElement }), onOpen: (modalElement) => this.open.emit({ modalElement }), onClose: (modalElement) => this.close.emit({ modalElement }) });
        //=> Show the Swal!
